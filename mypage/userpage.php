...
//２．データ登録SQL作成
$post = $pdo->prepare("SELECT * FROM post WHERE userid='$id'");
  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand" href=""><?=$username["name"]?>さんのページ</a>
        <a class="navbar-brand" href="../mypage/userfollowing.php?id=<?=$id?>">フォロー中</a>
        <a class="navbar-brand" href="../mypage/userfollowed.php?id=<?=$id?>">フォロワー</a>
      </div>
      <div>
        <a class="navbar-brand" href="../mypage/mypage.php"><?=$loginuser?></a>
