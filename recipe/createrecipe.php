...
// ３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO recipe(userid,title,ingredient1,ingredient2,ingredient3,url,recipememo,season,review,original,author,inputdate)VALUES(:userid,:title,:ingredient1,:ingredient2,:ingredient3,:url,:recipememo,:season,:review,0,:userid,sysdate())");
